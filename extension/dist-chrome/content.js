...
💡 ${suggestion}`;
    ...
    setup(__props, { emit: __emit }) {
      ...
      const handleAssign = async () => {
        ...
        try {
          ...
          const apiService = ApiService.getInstance();
          await apiService.assignProposal(props.proposalId, props.chain, authStore.state.user.address);
  ...
  const AssignModal = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-3676579e"]]);
