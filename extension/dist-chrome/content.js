  ...
  **/
  ...
  const _ApiService = class _ApiService {
    ...
    async getProposal(postId, chain) {
      try {
        const result = await this.request(`/dao/referendum/${postId}?chain=${chain}`);
    ...
    async getTeamActions(postId, chain) {
      try {
        const result = await this.request(`/dao/referendum/${postId}/actions?chain=${chain}`);
    ...
    async getAgreementSummary(postId, chain) {
      try {
        const result = await this.request(`/dao/referendum/${postId}/agreement-summary?chain=${chain}`);
    ...
    async getComments(postId, chain) {
      try {
        const result = await this.request(`/dao/referendum/${postId}/comments?chain=${chain}`);
  ...
  const _hoisted_1$i = { class: "wallet-connect" };
  ...
  const _hoisted_5$g = { class: "wallet-options" };
  const _hoisted_6$d = {
    key: 0,
    class: "wallet-list"
  };
  ...
  const _hoisted_15$6 = { class: "extension-status" };
  const _hoisted_16$6 = {
    key: 0,
...
💡 ${suggestion}`;
          ...
          createBaseVNode("div", _hoisted_3$i, [
            step.value === "select" ? (openBlock(), createElementBlock("div", _hoisted_4$g, [
              ...
              createBaseVNode("div", _hoisted_15$6, [
                extensionStatus.value === "checking" ? (openBlock(), createElementBlock("div", _hoisted_16$6, " 🔍 Checking for Polkadot Extension... ")) : extensionStatus.value === "not-found" ? (openBlock(), createElementBlock("div", _hoisted_17$6, [
                ...
                ])) : extensionStatus.value === "found" ? (openBlock(), createElementBlock("div", _hoisted_18$6, " ✅ Polkadot Extension detected ")) : createCommentVNode("", true)
              ])
  ...
  const WalletConnect = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-4f7ca26e"]]);
  ...
  const _hoisted_5$f = { class: "form-group" };
  ...
  const DAOConfigModal = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-973fd79d"]]);
  ...
  const _hoisted_1$g = { class: "status-badge-container" };
  ...
  const _hoisted_5$e = { class: "modal-content" };
  const _hoisted_6$b = { class: "status-options" };
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", _hoisted_1$g, [
          createBaseVNode("div", {
            ...
            _ctx.editable ? (openBlock(), createElementBlock("span", _hoisted_4$e, "edit")) : createCommentVNode("", true)
          ], 10, _hoisted_2$g),
  ...
  const StatusBadge = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-875347a1"]]);
  ...
  const _hoisted_5$d = { class: "filter-group" };
  const _hoisted_6$a = { class: "filter-group" };
  ...
  const _hoisted_15$5 = { class: "sort-controls" };
  const _hoisted_16$5 = { class: "results-info" };
  const _hoisted_17$5 = {
    key: 0,
    class: "loading-state"
  };
            ...
            createBaseVNode("div", _hoisted_2$f, [
              ...
              createBaseVNode("div", _hoisted_12$6, [
                createBaseVNode("div", _hoisted_13$5, [
                  ...
                  createBaseVNode("div", _hoisted_16$5, toDisplayString(filteredProposals2.value.length) + " of " + toDisplayString(unref(proposalStore).state.proposals.length) + " proposals ", 1)
                ]),
                createBaseVNode("div", {
                  class: normalizeClass(["proposals-container", viewMode.value])
                }, [
                  loading.value ? (openBlock(), createElementBlock("div", _hoisted_17$5, [..._cache[26] || (_cache[26] = [
                    createBaseVNode("div", { class: "spinner" }, null, -1),
                    createBaseVNode("p", null, "Loading proposals...", -1)
                  ])])) : filteredProposals2.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_18$5, [..._cache[27] || (_cache[27] = [
  ...
  const ProposalBrowser = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-db9e79d9"]]);
  ...
  const _hoisted_5$c = { class: "nav-section" };
  const _hoisted_6$9 = { class: "nav-section" };
  ...
  const _hoisted_15$4 = { class: "form-group" };
  const _hoisted_16$4 = { class: "readonly-field" };
  const _hoisted_17$4 = { class: "form-group" };
  const _hoisted_18$4 = { class: "team-members-list" };
  ...
  const SettingsMore = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-88029c73"]]);
  const _hoisted_1$d = { class: "my-dashboard" };
  const _hoisted_2$d = { class: "stats-section" };
  const _hoisted_3$d = { class: "stats-section-container" };
  const _hoisted_4$b = { class: "stat-number" };
  const _hoisted_5$b = { class: "stat-number" };
  const _hoisted_6$8 = { class: "stat-number" };
  const _hoisted_7$7 = { class: "stat-number" };
  const _hoisted_8$6 = { class: "content-section" };
  const _hoisted_9$6 = {
    key: 0,
    class: "content-area"
  };
  ...
  const _hoisted_13$3 = { class: "proposal-header" };
  const _hoisted_14$3 = { class: "proposal-id" };
  const _hoisted_15$3 = { class: "proposal-title" };
  const _hoisted_16$3 = { class: "proposal-meta" };
  const _hoisted_17$3 = { class: "meta-item" };
  const _hoisted_18$3 = { class: "meta-item" };
    ...
    setup(__props) {
      ...
      const myEvaluations2 = computed(() => {
        ...
        return dashboardProposals.value.filter(
          (p2) => p2.assigned_to === currentUser2 && p2.suggested_vote
        );
      });
          ...
          createBaseVNode("div", _hoisted_2$d, [
            createBaseVNode("div", _hoisted_3$d, [
              createBaseVNode("div", {
                ...
                onClick: _cache[0] || (_cache[0] = ($event) => activeTab.value = "assignments")
              }, [
                createBaseVNode("div", _hoisted_4$b, toDisplayString(myAssignments2.value.length), 1),
                _cache[4] || (_cache[4] = createBaseVNode("div", { class: "stat-label" }, "My Assignments", -1))
              ], 2),
              createBaseVNode("div", {
                class: normalizeClass(["stat-card", { active: activeTab.value === "actions" }]),
                onClick: _cache[1] || (_cache[1] = ($event) => activeTab.value = "actions")
              }, [
                createBaseVNode("div", _hoisted_5$b, toDisplayString(actionsNeeded2.value.length), 1),
                _cache[5] || (_cache[5] = createBaseVNode("div", { class: "stat-label" }, "Actions Needed", -1))
              ], 2),
              createBaseVNode("div", {
                class: normalizeClass(["stat-card", { active: activeTab.value === "evaluations" }]),
                onClick: _cache[2] || (_cache[2] = ($event) => activeTab.value = "evaluations")
              }, [
                createBaseVNode("div", _hoisted_6$8, toDisplayString(myEvaluations2.value.length), 1),
                _cache[6] || (_cache[6] = createBaseVNode("div", { class: "stat-label" }, "My Evaluations", -1))
              ], 2),
              createBaseVNode("div", {
                class: normalizeClass(["stat-card", { active: activeTab.value === "activity" }]),
                onClick: _cache[3] || (_cache[3] = ($event) => activeTab.value = "activity")
              }, [
                createBaseVNode("div", _hoisted_7$7, toDisplayString(activityCount.value), 1),
                _cache[7] || (_cache[7] = createBaseVNode("div", { class: "stat-label" }, "My Activity", -1))
              ], 2)
            ])
          ]),
          createBaseVNode("div", _hoisted_8$6, [
            activeTab.value === "assignments" ? (openBlock(), createElementBlock("div", _hoisted_9$6, [
              myAssignments2.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_10$6, [..._cache[8] || (_cache[8] = [
                createBaseVNode("div", { class: "empty-icon" }, "📭", -1),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(myAssignments2.value, (proposal) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_13$3, [
                      createBaseVNode("span", _hoisted_14$3, "#" + toDisplayString(proposal.post_id), 1),
                      createVNode(StatusBadge, {
                        status: proposal.internal_status,
                        "proposal-id": proposal.post_id,
                        editable: false
                    ...
                    createBaseVNode("h4", _hoisted_15$3, toDisplayString(proposal.title), 1),
                    createBaseVNode("div", _hoisted_16$3, [
                      createBaseVNode("div", _hoisted_17$3, [
                        _cache[9] || (_cache[9] = createBaseVNode("strong", null, "Timeline:", -1)),
  ...
  const MyDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-cabddfd5"]]);
  ...
  const _sfc_main$a = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
      ...
      const getAgreementCount = (proposal) => {
        var _a, _b;
        return ((_b = (_a = proposal.team_actions) == null ? void 0 : _a.filter(
          (action) => {
            var _a2;
            return ((_a2 = action.role_type) == null ? void 0 : _a2.toLowerCase()) === "agree";
          }
        )) == null ? void 0 : _b.length) || 0;
      };
      const getAgreedMembers = (proposal) => {
        var _a;
        const agreeActions = ((_a = proposal.team_actions) == null ? void 0 : _a.filter(
          (action) => {
            var _a2;
            return ((_a2 = action.role_type) == null ? void 0 : _a2.toLowerCase()) === "agree";
          }
      ...
      const getDiscussionMembers = (proposal) => {
        var _a;
        const discussionActions = ((_a = proposal.team_actions) == null ? void 0 : _a.filter(
  ...
  const Workflow = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-4f0cb230"]]);
  ...
  const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-c064f995"]]);
